...
// Workspace auth is a single shared password (kvasi_session cookie).
// Identity ("who am I?") is a separate, unsigned cookie (kvasi_who) — it's
// purely for tracking who's active, not for access control.
