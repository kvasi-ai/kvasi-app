...
export const SEED_PROGRAMS: ProgramSeed[] = [
  // ── TIER 1 ──
  // Programs offering <$250K total monetary support have been retired (see RETIRED_SLUGS).
  ...
  { slug:"msfh", name:"MS Founders Hub", org:"Microsoft", tier:1, kind:"credits", dilution:"non", visa:"open", loc:"remote", amount:"m", rolling:true, terms:"$150K–$350K Azure (with Pegasus tier)", note:"Self-serve. Stack on credits. Pegasus tier unlocks M12 + 24-mo enterprise GTM." },
  { slug:"gcp-ai", name:"GCP AI Tier", org:"Google", tier:1, kind:"credits", dilution:"non", visa:"open", loc:"remote", amount:"m", rolling:true, terms:"$250K–$350K GCP credits", note:"Self-serve. Stack on MS." },
  ...
  { slug:"afwerx", name:"AFWERX Open Topic (DAF SBIR 26.BZ Rel 1)", org:"USAF", tier:2, kind:"defense", dilution:"non", visa:"gated", loc:"remote", amount:"m", start_date:"2026-05-06", end_date:"2026-06-06", point_date:"2026-06-06", rolling:false, terms:"$75K Phase I → $1.7M Phase II → $1–15M STRATFI", note:"SBIR/STTR reauthorized April 13, 2026 (P.L. S.3971) through Sept 30, 2031. Current solicitation closes 2026-06-06. Requires US-citizen majority. Phase II + STRATFI total ≥$1.7M." },
...
// Slugs that previously existed but were renamed or removed.
// Used by the seed/upsert route to delete stale rows from the live DB.
export const RETIRED_SLUGS: string[] = [
  // Renamed in earlier cleanup
  "spc",         // → spc-fall26
  "newlab",      // → newlab-2027
  "a16z",        // → a16z-speedrun
  "converge",    // → openai-grove

  // Removed 2026-05-10 — sub-$250K monetary threshold cleanup
  "nvidia",          // $100K credits cap
  "zfellows",        // $10K
  "emergent",        // $5–50K
  "hf-lerobot",      // no monetary support (listing/blog only)
  "o1a",             // no monetary support (visa petition)
  "icorps",          // $50K
  "day-one",         // $100K
  "newlab-2027",     // $75K
  "blume-founders",  // $25–100K
  "techstars-space", // $20K + $200K MFN = $220K
  "alchemist",       // $25–175K
  "angels",          // variable, no guaranteed floor
];
